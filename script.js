const translations = {
    en: {
        ...
        spot_futures_analyzer: "Spot-Futures Analyzer",
        token_list: "Token List",
        open_interest: "Open Interest",
        "24h_volume": "24h Volume",
        alpha_tracker_pro: "New Token",
    ...
    ua: {
        ...
        funding_rate_title: "Ставка Фінансування",
        order_depth_title: "Глибина Стакану",
        domination_title: "Домінування",
        dex_explorer_title: "DEX Аналітика",
        cex_exchanges_title: "Централізовані Біржі (CEX)",
        spot_futures_analyzer: "Аналіз Спот-Ф'ючерсів",
        token_list: "Список токенів",
        open_interest: "Відкритий інтерес",
        "24h_volume": "Обʼєм 24г",
        alpha_tracker_pro: "Нові токени",
        nft_explorer_title: "NFT Explorer",
        airdrop_radar_title: "Радар Airdrop",
        defi_title: "DeFi Аналітика",
        ...
        price: "Ціна",
        change: "Зміна",
        support: "Рівень Підтримки",
        resistance: "Рівень Опору",
        favorites: "Обране",
    ...
    ru: {
        ...
        funding_rate_title: "Ставка Фандинга",
        order_depth_title: "Стакан Ордеров",
        domination_title: "Доминирование",
        dex_explorer_title: "Анализ DEX",
        cex_exchanges_title: "Централизованные Биржи (CEX)",
        spot_futures_analyzer: "Анализ Спот-Фьючерсов",
        token_list: "Список токенов",
        open_interest: "Открытый интерес",
        "24h_volume": "Объем за 24ч",
        alpha_tracker_pro: "Новые токены",
        nft_explorer_title: "NFT Explorer",
        airdrop_radar_title: "Радар Airdrop",
        defi_title: "Анализ DeFi",
...
var cardView = true; // Изменено с false на true
